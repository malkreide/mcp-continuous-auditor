...
scripts/          audit harness, live-probe, nightly-audit core, budget guard,
                  ...
                  release_gap.py = a DEPRECATED shim only: it forwards to
                  shipped_probe.py --metadata-only and translates the exit
                  codes and --format json keys back to the contract it had
                  before the two were merged. No probe logic lives here
...
tests/            stdlib unit tests (542 in 27 files) — run by .github/workflows/tests.yml
